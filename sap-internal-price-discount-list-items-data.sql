...
(      
    ...
    CONSTRAINT `SAPInternalPriceDiscountListItemsData` FOREIGN KEY (`PriceDiscountListID`) REFERENCES `sap_internal_price_discount_list_items_data` (`PriceDiscountListID`)
) ENGINE = InnoDB
